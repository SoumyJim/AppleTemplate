...
import sty from "./PlasmicButton.module.css"; // plasmic-import: AFYEhIL9o-Lr/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: uEr7QBy1yOQZ/icon
      ...
      >
        ...
        {(hasVariant($state, "withIcons", "withSuffixIcon") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__cwbBu)}
                  role={"img"}
                />
              ),
